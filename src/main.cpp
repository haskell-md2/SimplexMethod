...
void check(){
    ...
    std::cout << k1 * x1 + k2 * x2 + k3 * x3 + k4 * x4 + k5 * x5 << std::endl;

    std::cout << k1 * y1 + k2 * y2 + k3 * y3 + k4 * y4 + k5 * y5 ;
...
int run_program(int argc, char* argv[]){
    ...
    canonical->Print();
//    canonical->PrintCoffMatrixWithB();
//    std::cout << "---------------------" << std::endl;
//    canonical->PrintObjectiveCoefficients();
    ...
    try {
        ...
        std::cout << "enumSolutionSymmetric: x = " << enumSolutionSymmetric.transpose()  << std::endl;
...
//
//
////void check2(double a1, double a2, double a3, double a4, double a5 )
//
//void check(){
//    double k1 = -1;
//    double k2 = -5;
